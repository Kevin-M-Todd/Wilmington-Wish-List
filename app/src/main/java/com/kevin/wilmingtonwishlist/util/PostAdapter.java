...
import com.kevin.wilmingtonwishlist.HomeFragment;
import com.kevin.wilmingtonwishlist.WatchListFragment;
import com.kevin.wilmingtonwishlist.models.Post;
import com.kevin.wilmingtonwishlist.Home;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mPostImage = (BoxImage) itemView.findViewById(R.id.post_image);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mPostImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = (Fragment)((Home)mContext).getSupportFragmentManager()
                        .findFragmentByTag("android:switcher:" + R.id.viewpager_container + ":" +
                                ((Home)mContext).mViewPager.getCurrentItem());
                if(fragment != null){
                    ...
                    if(fragment.getTag().equals("android:switcher:" + R.id.viewpager_container + ":0")){
                        ...
                        HomeFragment searchFragment = (HomeFragment)((Home)mContext).getSupportFragmentManager()
                                .findFragmentByTag("android:switcher:" + R.id.viewpager_container + ":" +
                                        ((Home)mContext).mViewPager.getCurrentItem());
                    ...
                    //WatchList Fragment (AKA #1)
                        ...
                        WatchListFragment watchListFragment = (WatchListFragment)((Home)mContext).getSupportFragmentManager()
                                .findFragmentByTag("android:switcher:" + R.id.viewpager_container + ":" +
                                        ((Home)mContext).mViewPager.getCurrentItem());
